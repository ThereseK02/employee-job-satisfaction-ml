...
The Employee Job Satisfaction Prediction application is publicly deployed on Streamlit Community Cloud and enables real-time job satisfaction prediction using the trained Random Forest machine learning model.

---

### Welcome / Landing Page

![Welcome Page](images/streamlit-deployment/05_landing_page.png)

*Interactive landing page introducing the Employee Job Satisfaction Predictor, machine learning capabilities, project objectives, and application features before accessing the prediction system.*
...
*Real-time job satisfaction prediction generated by the deployed Random Forest machine learning model.*
